...
class Config:
    ...
    SPEAKING_COACH_PER_MINUTE_LIMIT = int(
        os.getenv("SPEAKING_COACH_PER_MINUTE_LIMIT", "5")
    )
    SPEAKING_COACH_PER_USER_DAILY_LIMIT = int(
        os.getenv("SPEAKING_COACH_PER_USER_DAILY_LIMIT", "50")
    )
    SPEAKING_COACH_GLOBAL_DAILY_LIMIT = int(
        os.getenv("SPEAKING_COACH_GLOBAL_DAILY_LIMIT", "500")
    )
    ...
    SPEAKING_COACH_DETAILED_RETENTION_DAYS = int(
        os.getenv(
            "SPEAKING_COACH_DETAILED_RETENTION_DAYS",
            os.getenv("SPEAKING_COACH_DIAGNOSTIC_RETENTION_DAYS", "90"),
        )
    )
    SPEAKING_COACH_HISTORY_RETENTION_DAYS = int(
        os.getenv("SPEAKING_COACH_HISTORY_RETENTION_DAYS", "365")
    )
    SPEAKING_COACH_PROCESSING_STALE_MINUTES = int(
        os.getenv("SPEAKING_COACH_PROCESSING_STALE_MINUTES", "10")
    )
